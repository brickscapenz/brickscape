...
const toRender = () => {
  return typeof window !== 'undefined' && (window.location.pathname == '/' || window.location.pathname == '') ? "jumbotron-hero jumbotron-fluid home-hero mb-0" : "jumbotron-hero jumbotron-fluid hero mb-0";
}
